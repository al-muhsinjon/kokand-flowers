...
const Navbar = () => {
  ...
  return (
    <>
    <nav className="w-[20%] h-[100vh] dark:bg-zinc-900 sticky top-0 flex  justify-center bg-blue-600">
      <div className="w-full flex flex-col justify-start items-center">
        {links.map((link) => (
          <NavLink
          className={(navData) =>
            navData.isActive
            ? "text-neutral-700 dark:text-slate-400 text-[23px]  font-montserrat font-semibold"
            : `dark:text-white text-white text-[23px] font-montserrat  dark:hover:text-slate-400 hover:text-zinc-600  font-semibold`
          }
          key={link.id}
          to={link.to}
          >
...
// className={(navData) =>
//   navData.isActive
//     ? "text-teal-500  text-[14px] font-montserrat font-semibold"
//     : `dark:text-white text-black text-[14px] font-montserrat dark:hover:text-teal-500 hover:text-teal-500 font-semibold`
// }

// text-[23px] font-semibold dark:text-neutral-700
